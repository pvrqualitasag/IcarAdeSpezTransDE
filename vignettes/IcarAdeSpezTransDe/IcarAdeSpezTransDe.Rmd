...
# r6objStat$setProject("ICAR-ADE-SpUe")
# r6objStat$setVersion("0.0.900")
# r6objStat$setDate("01.12.2015")
# r6objStat$setStatus("Erstellung")
# r6objStat$writeStatusToFile()
# r6objStat <- rqudocuhelper::R6ClassDocuStatus$new()
# r6objStat$setProject("ICAR-ADE-SpUe")
# r6objStat$setVersion("0.0.901")
# r6objStat$setDate("09.12.2015")
# r6objStat$setStatus("Zusammenfassung bis Zugang zur Dienstleistung")
# r6objStat$writeStatusToFile()
# r6objStat <- rqudocuhelper::R6ClassDocuStatus$new()
# r6objStat$setProject("ICAR-ADE-SpUe")
# r6objStat$setVersion("0.0.902")
# r6objStat$setDate("16.12.2015")
# r6objStat$setStatus("Zusammenfassung bis Lokale Anforderungen")
# r6objStat$writeStatusToFile()
# r6objStat <- rqudocuhelper::R6ClassDocuStatus$new()
# r6objStat$setProject("ICAR-ADE-SpUe")
# r6objStat$setVersion("0.0.903")
# r6objStat$setDate("24.02.2016")
# r6objStat$setStatus("Umstellung auf rqudochelper")
# r6objStat$writeStatusToFile()
# r6objStat <- rqudocuhelper::R6ClassDocuStatus$new()
# r6objStat$setProject("ICAR-ADE-SpUe")
# r6objStat$setVersion("0.0.904")
# r6objStat$setDate("24.02.2016")
# r6objStat$setStatus("Gemeinsame Komponenten")
# r6objStat$writeStatusToFile()
# r6objStat <- rqudocuhelper::R6ClassDocuStatus$new()
# r6objStat$setProject("ICAR-ADE-SpUe")
# r6objStat$setVersion("0.0.905")
# r6objStat$setDate("25.02.2016")
# r6objStat$setStatus("Abschluss Kapitel 3")
# r6objStat$writeStatusToFile()
# r6objStat <- rqudocuhelper::R6ClassDocuStatus$new()
# r6objStat$setProject("ICAR-ADE-SpUe")
# r6objStat$setVersion("0.0.906")
# r6objStat$setDate("01.03.2016")
# r6objStat$setStatus("Beginn Kapitel 4")
# r6objStat$writeStatusToFile()
# r6objStat <- rqudocuhelper::R6ClassDocuStatus$new()
# r6objStat$setProject("ICAR-ADE-SpUe")
# r6objStat$setVersion("0.0.907")
# r6objStat$setDate("18.05.2016")
# r6objStat$setStatus("Korrekturen und Ergänzungen bei Kap 1-4")
# r6objStat$setVersion("0.0.908")
# r6objStat$setDate("18.05.2016")
# r6objStat$setStatus("Anhang mit Beschreibung eines Webservice")
# r6objStat$writeStatusToFile()
...
Die Nachricht __UpdateMilkingResultRequest__ (siehe nachfolgendes Diagramm) ist konsistent mit der Spezifikation für generelle Anfragen. Diese Nachricht wird verwendet, um neue oder geänderte Daten von Melk-Ereignissen zum Dienstleister zu übermitteln
...
Die Nachricht __UpdateMilkingResultResponse__ ist konsistent mit der allgemeinen Spezifikation für Anfragen (siehe Generelle Spezifikationen und Antowrt-Spezifikationen). Diese Antwort dient zur Übermittlung und zum Empfang von Melk-Resultaten, wie sie vom Dienstleistungsanbieter verarbeitet werden.
...
Die Anfrage ist konsitent mit den allgemeinen Anforderungen für Anfragen
