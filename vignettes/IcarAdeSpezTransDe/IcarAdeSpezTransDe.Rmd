...
```{r R6DocuStatus, echo=FALSE, eval=FALSE}
sStatusFile  <-  "IcarAdeSpezTransDe.docstatus"
vecTableHeader <- c("Version",
                    "Datum",
                    "Wer",
                    "Änderung")

doc_status <- rcoursetools::R6DocuStatus$new()

doc_status$setTableHeader(psTableHeader = vecTableHeader)
doc_status$addRow(plTableRow = list(Version = "0.0.0.900",
                                        Date    = "01.12.2015",
                                        Who     = Sys.info()[["user"]],
                                        Change  = "Erstellung"))
doc_status$setStatusFile(psStatusFile = sStatusFile)
doc_status$writeStatusToFile()
...
robjDocuStatus$addRow(plTableRow = list(Version = "0.0.0.901",
                                        Date    = "09.12.2015",
                                        Who     = Sys.info()[["user"]],
                                        Change  = "Zusammenfassung erweitert bis Abschnitt \"Zugang zur  Dienstleistung\""))
robjDocuStatus$addRow(plTableRow = list(Version = "0.0.0.902",
                                        Date    = "16.12.2015",
                                        Who     = Sys.info()[["user"]],
                                        Change  = "Zusammenfassung erweitert bis Abschnitt \"Lokale Anforderungen\""))
robjDocuStatus$addRow(plTableRow = list(Version = "0.0.0.903",
                                        Date    = "24.02.2016",
                                        Who     = Sys.info()[["user"]],
                                        Change  = "Umstellung auf RPackage und rqudocuhelper"))
robjDocuStatus$addRow(plTableRow = list(Version = "0.0.0.904",
                                        Date    = "24.02.2016",
                                        Who     = Sys.info()[["user"]],
                                        Change  = "Gemeinsame Komponenten"))
robjDocuStatus$addRow(plTableRow = list(Version = "0.0.0.905",
                                        Date    = "25.02.2016",
                                        Who     = Sys.info()[["user"]],
                                        Change  = "Abschluss Kapitel 3"))
robjDocuStatus$addRow(plTableRow = list(Version = "0.0.0.906",
                                        Date    = "01.03.2016",
                                        Who     = Sys.info()[["user"]],
                                        Change  = "Beginn Kapitel 4"))
#robjDocuStatus$addRow(plTableRow = list(Version = "0.0.0.907",
#                                        Date    = "",
#                                        Who     = Sys.info()[["user"]],
#                                        Change  = ""))
...
```{r echo=FALSE, results='asis'}
rqudocuhelper::insertOdgAsPdf(psOdgFileStem = "OrgSpezDiagramm3")
```
